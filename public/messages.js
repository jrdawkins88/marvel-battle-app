...
var messages = {
    round : {
        ...
        draw : [
            [ "The combatants stare across the broken and devastated landscape. They have come to a standstill. 'This isn't over', says ", 0, ". ", 1, " nods and turns away, teeth gritted in frustration. 'I'll get you next time.' The fight is a draw!"  ],
    ...
    shoot : {
        failed : {
            ...
            blocked : [
                [ 0, " launches a devastating blow, but ", 1, " deftly parries it." ],
        ...
        success : [
            [ 0, " launches a devastating salvo of attacks against ", 1 ],
